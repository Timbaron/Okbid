            ...
            <div class="product-details-slider owl-theme owl-carousel" id="sync1">
                ...
                <div class="slide-top-item">
                    <div class="slide-inner">
                        <img src="{{asset('storage/display_images/'.$product->display_image)}}" style="max-width: 1110px; max-height: 585px;" alt="product">
                    </div>
                </div>
                @endif
            </div>
        ...
        <div class="product-details-slider-wrapper">
            <div class="product-bottom-slider owl-theme owl-carousel" id="sync2">
                ...
                <div class="slide-bottom-item">
                    <div class="slide-inner">
                        <img src="{{asset('storage/other_images/'.$image)}}" alt="product">
                    </div>
                </div>
                @endforeach
                ...
                <div class="product-details-content">
                    ...
                    <ul class="price-table mb-30">
                        <li class="header">
                            ...
                            <h3 class="price">US ${{$product->starting_price}}.00</h3>
                        </li>
                        <li>
